...
bool M5Stack_UNIT_LoRaWAN::checkJoinStatus() {
    String restr;
    writeCMD("AT+CSTATUS?\r\n");
    restr = waitMsg(500);
...
String M5Stack_UNIT_LoRaWAN::waitMsg(unsigned long time) {
    String restr;
...
void M5Stack_UNIT_LoRaWAN::sendMsg(uint8_t confirm, uint8_t nbtrials, size_t length,
                           String data) {
...
String M5Stack_UNIT_LoRaWAN::receiveMsg() {
...
void M5Stack_UNIT_LoRaWAN::configOTTA(String device_eui, String app_eui, String app_key,
                              String ul_dl_mode) {
...
void M5Stack_UNIT_LoRaWAN::configABP(String device_addr, String app_skey,
...
void M5Stack_UNIT_LoRaWAN::setClass(String mode) {
    writeCMD("AT+CCLASS=" + mode + "\r\n");
}

void M5Stack_UNIT_LoRaWAN::setRxWindow(String freq) {
    writeCMD("AT+CRXP=0,0," + freq + "\r\n");
}

void M5Stack_UNIT_LoRaWAN::setFreqMask(String mask) {
    writeCMD("AT+CFREQBANDMASK=" + mask + "\r\n");
}

void M5Stack_UNIT_LoRaWAN::startJoin() {
